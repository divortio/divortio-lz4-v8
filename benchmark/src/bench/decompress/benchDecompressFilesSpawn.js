/**
 * benchmark/src/bench/decompress/benchDecompressFilesSpawn.js
 */
...
const CLI_Script = path.join(__dirname, 'benchDecompressFilesCLI.js');

export class BenchDecompressFilesSpawn {
        ...
        try {
            ...
            for (const [fileKey, libMap] of Object.entries(rawMap)) {
                ...
                for (const [libKey, samples] of Object.entries(libMap)) {
                    this.results[fileKey][libKey] = DecompressionResults.fromJSON(samples);
                }
            }
        } catch (e) {
