/**
 * benchmark/src/bench/roundtrip/benchRoundtripSpawn.js
 */
...
const CLI_Script = path.join(__dirname, 'benchRoundtripCLI.js');

export class BenchRoundtripSpawn {
    ...
    run() {
        ...
        try {
            ...
            for (const [key, samples] of Object.entries(rawMap)) {
                this.results[key] = RoundtripResults.fromJSON(samples);
            }
        } catch (e) {
